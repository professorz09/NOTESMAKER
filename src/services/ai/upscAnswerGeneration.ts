...
• उपशीर्षकों की संख्या और नाम प्रश्न से आने चाहिए — हर उत्तर में ठीक वही 3 भाग या वही क्रम मत दोहराएं। एक तुलनात्मक प्रश्न तुलना जैसा पढ़ना चाहिए, एक आलोचनात्मक प्रश्न आलोचना जैसा।
• भूमिका का उद्धरण भी विषय के अनुसार बदलें — कभी दोहा, कभी कोई गद्यांश-पंक्ति, कभी कोई ऐतिहासिक/आलोचनात्मक कथन — हमेशा एक ही ढंग से शुरुआत न करें।
${multiVariant ? MULTI_VARIANT_RULE('Hindi') : ''}
HTML में लिखें: <h3> उपशीर्षक के लिए, <ul><li> बिंदुओं के लिए, <strong> मुख्य शब्दों/उद्धरणों/आलोचक-नामों के लिए।
