...
${lengthLineHi(marks)}
उत्तर शैली: ${style === 'bullets' ? 'बिंदुवार (Bullet Points)' : style === 'analytical' ? 'विश्लेषणात्मक' : style === 'classic' ? 'शास्त्रीय शैली — उद्धरण/उदाहरण से भूमिका, विवेचना, सशक्त निष्कर्ष' : style === 'auto' ? 'AI Auto (सर्वोत्तम स्वाभाविक संरचना)' : 'टॉपर की प्रतिलिपि'}
...
${style === 'auto' ? `   - (AI Auto विशेष): यदि प्रश्न में किसी रचना या कवि का सीधा शास्त्रीय दोहा तुरंत न मिले, तो सूखी परिभाषा लिखने के बजाय विषय से जुड़ा कोई प्रासंगिक काव्यात्मक हुक या उपयुक्त उदाहरण (जैसे यूनिकोड/कम्प्यूटर और हिन्दी पर कवि अशोक चक्रधर की पंक्तियाँ, भारतेन्दु हरिश्चंद्र, कबीर आदि) जोड़ें ताकि उत्तर और बेहतर बन सके।` : ''}
