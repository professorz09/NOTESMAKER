...
const LEVELS: { id: DetailLevel; label: string; desc: string }[] = [
  ...
  { id: 'detailed', label: 'Detailed', desc: 'पूरा topic • सबसे विस्तृत' },
];
    ...
    {mode === 'topic' && detailLevel !== 'normal' && (
      <p className="text-[9.5px] text-slate-600 leading-relaxed px-0.5">
        {detailLevel === 'detailed'
          ? 'AI पहले पूरा structure बनाएगा, फिर हर heading + sub-heading को गहराई में लिखेगा, और अंत में बचे बिंदु जोड़ेगा।'
          : 'AI पहले structure बनाएगा, फिर हर मुख्य heading को depth में expand करेगा।'}
      </p>
    )}
  </div>
);
