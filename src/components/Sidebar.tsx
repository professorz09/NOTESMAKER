...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      >
        {/* ── HEADER ── */}
        <div className="flex-shrink-0 px-5 py-4 flex items-center justify-between border-b border-white/6">
          <div className="flex items-center gap-3">
            <div className="relative flex-shrink-0">
              ...
              <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-emerald-400 rounded-full border-2 border-[#0b1120] animate-pulse" />
            </div>
            <div>
              <h1 className="text-[15px] font-extrabold tracking-tight text-white leading-none">Professor UPSC</h1>
              <p className="text-[10px] font-semibold tracking-widest text-blue-400/70 uppercase mt-0.5">AI Book Writer</p>
            </div>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
